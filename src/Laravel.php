    ...
    public function esc(): callable
    {
        return static function (ContainerConfigurator $containerConfigurator) : void {
            ...
            $services
                ...
                ->set(ArraySyntaxFixer::class)->call('configure', [['syntax' => 'short']])
                ...
                ->set(BracesFixer::class)->call('configure', [['allow_single_line_closure' => true]])
                ...
                ->set(ClassDefinitionFixer::class)->call('configure', [['single_line' => true]])
                ...
                ->set(NoUnneededCurlyBracesFixer::class)->call('configure', [['namespaces' => true]])
                ...
                ->call('configure', [['elements' => [TrailingCommaInMultilineFixer::ELEMENTS_ARRAYS]]])
                ...
                ->set(ConcatSpaceFixer::class)->call('configure', [['spacing' => 'none']])
